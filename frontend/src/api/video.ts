...
import type { SearchVideoResponse, Video } from './types'
...
export function searchVideos(input: { keyword: string; limit: number; latest_time: number }) {
  return postJson<SearchVideoResponse>('/video/search', input)
}
